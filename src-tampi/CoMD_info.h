...
#define CoMD_HOSTNAME "cirrus-login1"
...
#define CoMD_COMPILER_VERSION "'gcc (GCC) 6.3.0'"
#define CoMD_CFLAGS "'-std=c99 -fopenmp -DDOUBLE -DDO_MPI -O5   -I/home/shared/dc025/tampi-install/include'"
